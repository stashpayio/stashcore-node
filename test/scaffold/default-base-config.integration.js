...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    stashd.spawn.datadir.should.equal(home + '/.stash');
    stashd.spawn.exec.should.equal(path.resolve(__dirname, process.env.HOME, './.stash/stashd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.stashd.spawn.datadir.should.equal('./data2');
  });
});
