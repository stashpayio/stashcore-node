...
module.exports.services.Stash = require('./lib/services/stashd');
...
module.exports.cli.stashcore = require('./lib/cli/stashcore');
module.exports.cli.stashcored = require('./lib/cli/stashcored');

module.exports.lib = require('@stashcore/stashcore-lib');
