 ...
 * @param {String} options.httpsOptions.ca - Path to ca file
...
WebService.prototype.transformHttpsOptions = function() {
  if(!this.httpsOptions || !this.httpsOptions.key || !this.httpsOptions.cert  || !this.httpsOptions.ca) {
  ...
  this.httpsOptions = {
    ...
    ca: fs.readFileSync(this.httpsOptions.ca)
  };
};
