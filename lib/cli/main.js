...
var stashcorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = stashcorenode.version;
  var create = stashcorenode.scaffold.create;
  var add = stashcorenode.scaffold.add;
  var start = stashcorenode.scaffold.start;
  var remove = stashcorenode.scaffold.remove;
  var callMethod = stashcorenode.scaffold.callMethod;
  var findConfig = stashcorenode.scaffold.findConfig;
  var defaultConfig = stashcorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the Stash database directory')
  ...
  program
    ...
    .option('-d, --daemon', 'Make stashcore-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `stashcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ stashcore-node add wallet-service');
      console.log('    $ stashcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ stashcore-node remove wallet-service');
      console.log('    $ stashcore-node remove insight-api');
      console.log();
    });
